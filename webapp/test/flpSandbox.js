		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Atualização Tabela Parâmetros ZPSTA_PARAM_CFGTT",
									"targetURL": "#portosegurozpstacfgtt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"portosegurozpstacfgtt-display": {
								"semanticObject": "portosegurozpstacfgtt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=portoseguro.zpstacfgtt",
									"url": sap.ui.require.toUrl("portoseguro/zpstacfgtt")
								}
							}
						}
					}
